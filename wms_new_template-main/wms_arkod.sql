...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 26, 2024 at 10:12 AM
...
INSERT INTO `clients` (`id`, `name`, `email`, `address`, `postcode`, `attention`, `tel`, `uid`, `created_at`, `updated_at`) VALUES
(1, 'Yee Lee Marketing', 'test', 'test', 0, 'test', 'test', NULL, '2024-06-10 03:42:46', '2024-08-26 07:59:40'),
(28, 'Drinking Water', 'water@gmail.com', 'kk', NULL, 'qq', 'qq', 30, '2024-06-24 00:50:15', '2024-06-24 22:15:07'),
(29, 'Power Solutions Sdn Bhd (154852-A)', '11@gmail.com', '65, Jln P10/21, Selaman Ind. Park,43650 Bandar Baru Bangi, Selangor', 43650, 'Austin Fong/Nivian Chan', '03-8926 1104 /012-200 5597', 15, '2024-08-12 18:23:04', '2024-08-19 02:35:17'),
(31, 'Agro Bank Labuan', '12@gmail.com', 'No. UO374, Jalan Anggerik,87008, Wilayah Persekutuan Labuan MY,87008 Labuan, Sabah', 87008, NULL, '087 - 408 200/087 - 408 988', 15, '2024-08-12 18:24:34', '2024-08-15 18:23:43'),
(32, 'Agro Bank @ Lahad Datu Branch', '13@gmail.com', 'I-peak Business Centre, MDLD 8992,Jln Lahad Datu - Tungku,91110 Lahad Datu, Sabah', 91110, NULL, '089 - 882 561/089 - 882 562', 15, '2024-08-12 18:26:21', '2024-08-15 18:23:28');
...
CREATE TABLE `invoices` (
  ...
  `sstPercentage` int(10) DEFAULT NULL,
...
INSERT INTO `notifications` (`id`, `message`, `is_read`, `uid`, `created_at`, `updated_at`) VALUES
(13, 'Product name pm is waiting to be approved.', 0, 1, '2024-08-08 17:37:13', '2024-08-08 17:37:13'),
(14, 'Product name pm is waiting to be approved.', 0, 2, '2024-08-08 17:37:13', '2024-08-08 17:37:13'),
(15, 'Product name pm is waiting to be approved.', 0, 4, '2024-08-08 17:37:13', '2024-08-08 17:37:13'),
(16, 'Product name pm is waiting to be approved.', 0, 12, '2024-08-08 17:37:13', '2024-08-08 17:37:13'),
(18, '  Your product name test has been approved.', 0, 30, '2024-08-08 17:38:59', '2024-08-08 17:38:59'),
(19, '  Your product name pm has been approved.', 0, 30, '2024-08-08 17:39:04', '2024-08-08 17:39:04'),
(20, '  Your product name pm has been rejected.', 0, 30, '2024-08-08 17:39:27', '2024-08-08 17:39:27'),
(24, 'Product name pm has been updated.', 0, 30, '2024-08-15 19:58:37', '2024-08-15 19:58:37');
...
INSERT INTO `products` (`id`, `name`, `SKU`, `product_desc`, `expired_date`, `Img`, `UOM`, `weight_per_unit`, `client_id`, `status`, `created_at`, `updated_at`, `uid`, `partner_id`) VALUES
(48, 'dd', '2', NULL, '2024-08-30', '202408010633.png', 'dd', 2, 1, 'Approved', '2024-07-31 22:33:05', '2024-08-08 07:11:56', 15, NULL),
(51, 'dd', '2', NULL, '2024-08-30', '202408080217.jpg', 'ctn', 4, 28, 'Approved', '2024-08-07 18:17:45', '2024-08-08 07:12:14', 30, NULL),
(54, 'dd', 'dd', NULL, '2024-08-31', '202408080757.jpg', 'ctn', 5, 28, 'Pending', '2024-08-08 07:57:45', '2024-08-07 23:57:45', 30, NULL),
(57, 'pm', '2', NULL, '2024-08-29', '202408080809.jpg', 'ctn', 43123, 28, 'Approved', '2024-08-08 08:09:04', '2024-08-15 19:58:37', 30, NULL),
(60, 'pm', 'idk', NULL, '2024-08-21', '202408080825.jpg', 'ctn', 4, 28, 'Pending', '2024-08-08 08:25:42', '2024-08-08 00:25:42', 30, NULL),
(62, 'pm', 'dd', NULL, '2024-09-04', '202408090137.jpg', 'ctn', 2, 28, 'Pending', '2024-08-09 01:37:13', '2024-08-08 17:37:13', 30, NULL),
(63, 'pm', '2', NULL, '2024-08-27', '202408090200.jpg', 'ctn', 9, 28, 'Approved', '2024-08-09 02:00:50', '2024-08-08 23:17:55', 15, NULL);
...
CREATE TABLE `waybills` (
  ...
  `shipper_postcode` varchar(20) NOT NULL,
  `shipper_attention` varchar(100) DEFAULT NULL,
  `shipper_tel` varchar(50) NOT NULL,
  `shipper_email` varchar(255) DEFAULT NULL,
  `receiver_name` varchar(100) NOT NULL,
  `receiver_address` varchar(255) NOT NULL,
  `receiver_postcode` varchar(20) NOT NULL,
  `receiver_attention` varchar(100) DEFAULT NULL,
  `receiver_tel` varchar(50) NOT NULL,
  `receiver_email` varchar(255) DEFAULT NULL,
  `order_content` varchar(255) DEFAULT NULL,
  `order_category` varchar(100) DEFAULT NULL,
  `order_size` varchar(50) DEFAULT NULL,
  `order_total_weight` varchar(255) DEFAULT NULL,
  `remarks` text DEFAULT NULL,
...
INSERT INTO `waybills` (`id`, `waybill_no`, `no`, `date`, `customer_id`, `service_type`, `shipper_name`, `shipper_address`, `shipper_postcode`, `shipper_attention`, `shipper_tel`, `shipper_email`, `receiver_name`, `receiver_address`, `receiver_postcode`, `receiver_attention`, `receiver_tel`, `receiver_email`, `order_content`, `order_category`, `order_size`, `order_total_weight`, `remarks`, `status`, `created_at`, `updated_at`) VALUES
(72, 'ARKODWB-260824-001PS', 1, '2024-08-26', 'PS', 'Door to Door', 'Power Solutions Sdn Bhd (154852-A)', '65, Jln P10/21, Selaman Ind. Park,43650 Bandar Baru Bangi, Selangor', '43650', 'Austin Fong/Nivian Chan', '03-8926 1104 /012-200 5597', '-', 'Agro Bank @ Lahad Datu Branch', 'I-peak Business Centre, MDLD 8992,Jln Lahad Datu - Tungku,91110 Lahad Datu, Sabah', '91110', '-', '089 - 882 561/089 - 882 562', '-', 'UPS INVT', '6KVA', '66.5cm x 33 cmx 89 cm', '71.0kg', NULL, 1, '2024-08-26 00:06:40', '2024-08-26 00:06:40');
